...
class GIFImage(object):
    def __init__(self, filename=None, roration: pygame.math.Vector2=None):
        self.frames = []
        self.rotation = roration
    ...
    def get_frames(self):
        ...
        try:
            while 1:
                ...
                pi = pilImageToSurface(image.convert("RGBA"))
    ...
    def render(self, screen, pos):
        ...
        screen.blit(pygame.transform.rotate(self.frames[self.cur][0], self.rotation if self.rotation else 0) , pos)
    ...
    def get_size(self):
        return pygame.transform.rotate(self.frames[self.cur][0], self.rotation if self.rotation else 0).get_size()
    def length(self):
